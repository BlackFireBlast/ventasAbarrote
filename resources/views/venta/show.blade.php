...
@section('content')
    ...
    <div class="container w-100  rounded p-4 mt-3">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{$venta->comprobante->tipo_comprobante}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            <div class="col-sm-4">
                <div class="input-group mb-3">
                    ...
                    <input type="text" disabled class="form-control"  value="Número de comprobante:">
                </div>
            </div>
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{$venta->numero_comprobante}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{$venta->cliente->persona->razon_social}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            <div class="col-sm-4">
                <div class="input-group mb-3">
                    ...
                    <input type="text" disabled class="form-control"  value="Vendedor:">
                </div>
            </div>
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{$venta->user->name}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{ \Carbon\Carbon::parse($venta->fecha_hora)->format('d-m-Y')}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{ \Carbon\Carbon::parse($venta->fecha_hora)->format('H:i')}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input id="input-impuesto" type="text" disabled class="form-control" value="{{$venta->impuesto}}">
            </div>
        </div>
