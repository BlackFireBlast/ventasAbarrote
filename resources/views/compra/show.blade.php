...
@section('content')
    ...
    <div class="container w-100  rounded p-4 mt-3">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{$compra->comprobante->tipo_comprobante}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{$compra->proveedore->persona->razon_social}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{ \Carbon\Carbon::parse($compra->fecha_hora)->format('d-m-Y')}}">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" disabled class="form-control" value="{{ \Carbon\Carbon::parse($compra->fecha_hora)->format('H:i')}}">
            </div>
        </div>
